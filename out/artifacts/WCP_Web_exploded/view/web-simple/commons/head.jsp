...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<ul class="nav navbar-nav">
			<li class="button">
				<%--<a href="websearch/PubHome.html">--%>
					<%--<span class="btn btn-default"></span>&nbsp;Home</a>--%>
				<%--<form action="/webstat/PubHome.do" method="post"--%>
					  <%--id="lucenesearchFormId"--%>
					  <%--class="navbar-form navbar-left hidden-xs hidden-sm" role="search">--%>
					<%--<button type="submit" class="btn btn-default btn-sm">Home</button>--%>
				<%--</form>--%>
				<div style="margin-top: 10px;"></div>
				<%--<a class="btn btn-primary" href="/webstat/PubHome.do" role="button">Home</a>--%>
